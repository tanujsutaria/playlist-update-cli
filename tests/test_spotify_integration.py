...
class TestSearchSong:
    ...
    def test_search_song_exact_match(self, real_spotify_manager_with_mock_client):
        ...
        song = Song(
            id="test artist|||test song", name="test song", artist="test artist", spotify_uri=None
        )
    ...
    def test_search_song_fuzzy_match(self, real_spotify_manager_with_mock_client):
        ...
        manager = real_spotify_manager_with_mock_client
        song = Song(id="beatles|||hey jude", name="hey jude", artist="beatles", spotify_uri=None)
    ...
    def test_search_song_not_found(self, real_spotify_manager_with_mock_client):
        ...
        manager = real_spotify_manager_with_mock_client
        song = Song(
            id="unknown|||nonexistent", name="nonexistent", artist="unknown", spotify_uri=None
        )
...
class TestGetPlaylistTracks:
    ...
    def test_get_playlist_tracks_empty(self, real_spotify_manager_with_mock_client):
        ...
        manager = real_spotify_manager_with_mock_client
        manager.sp.playlist_tracks.return_value = {"items": [], "next": None}
...
class TestRefreshPlaylist:
    ...
    def test_refresh_playlist_deletes_existing(
    ...
    def test_refresh_playlist_creates_new(
        self, real_spotify_manager_with_mock_client, sample_songs
    ):
    ...
    def test_refresh_playlist_adds_tracks(
        self, real_spotify_manager_with_mock_client, sample_songs
    ):
...
class TestAppendToPlaylist:
    ...
    def test_append_to_nonexistent_creates_playlist(
        self, real_spotify_manager_with_mock_client, sample_songs
    ):
